...
\node[box, fill=neutralbox, draw=neutralline, minimum width=3.6cm, below=1.6cm of review] (productuse) {\textbf{Product use}\\[2pt]\footnotesize No measured increase\\\footnotesize in the matched study};
\draw[->, neutralline, line width=1pt] (release.south) |- (productuse.east);
