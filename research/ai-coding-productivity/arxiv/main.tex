...
A systematic review of 116 empirical studies finds coding-stage gains of roughly 20--30\%, but only 10--30\% higher release output in the strongest delivery evidence. Agent-native cases report a 4.5$\times$ median and an 18$\times$ task-specific upper end, although these low-weight estimates depend on redesigned workflows and scaled verification.
\end{abstract}
